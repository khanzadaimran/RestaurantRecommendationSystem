...
//       <Image style={{width:111, height:100,top:47,left:133,position:"absolute",borderRadius:360}} source={require('../Images/logo.jpg')} />
...
// </Left>
// <Button full  style={styles.loginButton} onPress={()=>this.props.navigation.navigate('Deal')} ><Text style={{color:'white'}} >Login</Text></Button>
...
//   <Button full  style={styles.loginButton} onPress={()=>this.changeloginstaus()} ><Text style={{color:'white'}}  >Sign up</Text></Button>
//       </View>
//       <Left>
//           <Text style={styles.fbLoginButton} >OR</Text>    
//             </Left>
